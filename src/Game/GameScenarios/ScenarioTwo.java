 ...
 * @author Thong Nguyen
 */
public class ScenarioTwo implements BaseGame {
    ...
    public void init() {
        ...
        players.get(1).setBattle("Roll");
        //Set distance traveled
        players.get(0).setTraveled(150);
        players.get(1).setTraveled(200);
    }
    ...
    public String toString() {
        return "Scenario 2: When the deck is out of cards.";
    }
}
